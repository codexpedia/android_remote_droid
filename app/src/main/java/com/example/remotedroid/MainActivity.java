...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //this activity extends View.OnClickListener, set this as onClickListener for all buttons
    ...
    public class ConnectPhoneTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            isConnected = result;
            Toast.makeText(getApplication(), isConnected ? "Connected to server!" : "Error while connecting", Toast.LENGTH_LONG).show();
            try {
                if (isConnected) {
                ...
                Toast.makeText(getApplication(), "Error while connecting", Toast.LENGTH_LONG).show();
            }
        }
    }
}
